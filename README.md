...
<img width="1620" height="1125" alt="image" src="https://github.com/user-attachments/assets/cb2ffc90-4869-46dc-8a0d-95d8486f2eab" />

Oh boy, I did not expect G to stablize itself as well, exactly around ~-30 .. something about 8 times pi + a little but of RNG jiggle still? :))

Data points confirmed, now it's just.. . more pretty visuals! Ssadly, this run didn't have graph saving/writing yet during it, so will need to re-run to extract more pretty pictures than sheer metrics, the end state, looks identical of course.
...
gravity stabilizing for free already, whaaaaaat
